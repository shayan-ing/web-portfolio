...
import DeltaLogo from './assets/company_logo/Delta 6.0.png';
import DSALogo from './assets/company_logo/DSA.png';
import DALogo from './assets/company_logo/DA.png';
...
export const SkillsInfo = [
  ...
  export const experiences = [
    {
      ...
      desc: "Earned a Full Stack Web Development (MERN) certification from Apna College, covering frontend and backend development, REST APIs, database integration, authentication, and deployment. Built multiple real-world projects using React, Node.js, Express, and MongoDB.",
      skills: [
        "HTML",
        "CSS",
        "JavaScript",
    ...
    },
    {
      id: 1,
      img: DSALogo,
      role: "Decode C++ with DSA",
      company: "PW Skills",
      date: "December 2024 - May 2025",
      desc: "Earned a certification in Data Structures and Algorithms using C++ from PW Skills, gaining hands-on experience with arrays, linked lists, stacks, queues, trees, graphs, recursion, time complexity, and competitive programming concepts.",
      skills: [
        "Data Structures",
        "Algorithms",
        "C++",
    ...
    },
    {
      id: 2,
      img: DALogo,
      role: "Data Analytics Using Power BI",
      company: "Lets Upgrade - National Skill Development Corporation (NSDC)",
      date: "July 2024 - August 2024",
      desc: "Earned a certification in Data Analytics with Power BI, focusing on data preparation, data modeling, DAX calculations, and designing dynamic, visually compelling dashboards. Learned to transform raw datasets into meaningful business insights.",
      skills: [
        "MS Excel",
        "Power BI",
        "Pandas",
  ...
  export const projects = [
    ...
    },
    {
      ...
      title: "Web-Portfolio",
      description:
        "A clean, responsive web portfolio showcasing my projects, skills, and experience with a modern UI and smooth user experience.",
      image: portfolioLogo,
      ...
      webapp: "https://shayan-akhtar-abedeen.vercel.app/",
    },
    // {
    //   id: 6,
    //   title: "Coding Master",
